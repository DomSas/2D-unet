...
def load_test_data():
    ...
    masks_test = np.load('imgs_test2021mar.npy')
...
#     imgs_mask_train /= 255.  # scale masks to [0, 1]
    ...
    my_callbacks = [ModelCheckpoint('weights.h5', monitor='dice_coef', save_best_only=True), EarlyStopping(monitor='val_loss', min_delta=0, patience=4, verbose=0, mode='auto')]
#    model.load_weights('weights.h5')

    print('-'*30)
    print('Fitting model...')
    print('-'*30)
    history = model.fit(imgs_train, imgs_mask_train, batch_size=32, epochs=50, verbose=1, shuffle=True,
