...
def load_train_data():
    imgs_train = np.load('imgs_train2021feb.npy')
    masks_train = np.load('masks_train2021feb.npy')
...
#    model.load_weights('weights.h5')
    ...
    print('Fitting model...')
    print('-'*30)
    history = model.fit(imgs_train, imgs_mask_train, batch_size=32, epochs=100, verbose=1, shuffle=True,
